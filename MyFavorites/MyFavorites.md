MyFavorites – компонент MODX Revolution 3.x, который позволяет добавить на сайт списки избранного. Основной упор сделан на работу с анонимными пользователями, аналитикой и защитой от ботов.

Требования: MODX Revolution 3.x, PHP >= 8.4.
...
[![Кнопки избранного в каталоге товаров](https://raw.githubusercontent.com/Prihod/modx-extras-docs/main/MyFavorites/images/catalog.png)](https://raw.githubusercontent.com/Prihod/modx-extras-docs/main/MyFavorites/images/catalog.png)
...
[![Дашборд: KPI и динамика активности](https://raw.githubusercontent.com/Prihod/modx-extras-docs/main/MyFavorites/images/dashboard_1.png)](https://raw.githubusercontent.com/Prihod/modx-extras-docs/main/MyFavorites/images/dashboard_1.png)

[![Дашборд: топ ресурсов и распределения действий, типов пользователей, браузеров](https://raw.githubusercontent.com/Prihod/modx-extras-docs/main/MyFavorites/images/dashboard_2.png)](https://raw.githubusercontent.com/Prihod/modx-extras-docs/main/MyFavorites/images/dashboard_2.png)

[![Дашборд: лента последних событий и начало блока «Безопасность»](https://raw.githubusercontent.com/Prihod/modx-extras-docs/main/MyFavorites/images/dashboard_3.png)](https://raw.githubusercontent.com/Prihod/modx-extras-docs/main/MyFavorites/images/dashboard_3.png)

[![Дашборд: блок «Безопасность», топ IP по алертам и алерты по дням](https://raw.githubusercontent.com/Prihod/modx-extras-docs/main/MyFavorites/images/dashboard_4.png)](https://raw.githubusercontent.com/Prihod/modx-extras-docs/main/MyFavorites/images/dashboard_4.png)

[![Дашборд: алерты по дням и лента последних алертов](https://raw.githubusercontent.com/Prihod/modx-extras-docs/main/MyFavorites/images/dashboard_5.png)](https://raw.githubusercontent.com/Prihod/modx-extras-docs/main/MyFavorites/images/dashboard_5.png)
...
[![Грид «Пользователи»](https://raw.githubusercontent.com/Prihod/modx-extras-docs/main/MyFavorites/images/users.png)](https://raw.githubusercontent.com/Prihod/modx-extras-docs/main/MyFavorites/images/users.png)

**Избранное** — все позиции избранного по всем посетителям, с группировкой по ресурсам и
фильтрами.

[![Грид «Избранное»](https://raw.githubusercontent.com/Prihod/modx-extras-docs/main/MyFavorites/images/favorites.png)](https://raw.githubusercontent.com/Prihod/modx-extras-docs/main/MyFavorites/images/favorites.png)

**Списки** — все списки избранного (`default` и пользовательские): идентификатор, публичный
ключ, контекст, язык и хост.

[![Грид «Списки»](https://raw.githubusercontent.com/Prihod/modx-extras-docs/main/MyFavorites/images/lists.png)](https://raw.githubusercontent.com/Prihod/modx-extras-docs/main/MyFavorites/images/lists.png)

**Бан лист** — управление чёрным списком IP: добавление, редактирование и удаление,
временные и перманентные баны.

[![Грид «Бан лист»](https://raw.githubusercontent.com/Prihod/modx-extras-docs/main/MyFavorites/images/banlist.png)](https://raw.githubusercontent.com/Prihod/modx-extras-docs/main/MyFavorites/images/banlist.png)

**Лог** — журнал действий (включая «Срабатывание защиты») со статусом, IP и агентом.

[![Грид «Лог»](https://raw.githubusercontent.com/Prihod/modx-extras-docs/main/MyFavorites/images/log.png)](https://raw.githubusercontent.com/Prihod/modx-extras-docs/main/MyFavorites/images/log.png)
